...
smarty_core_load_plugins(array('plugins' => array(array('function', 'lang_get', 'navBar.tpl', 17, false),array('function', 'config_load', 'navBar.tpl', 22, false),array('modifier', 'replace', 'navBar.tpl', 21, false),array('modifier', 'escape', 'navBar.tpl', 35, false),array('modifier', 'truncate', 'navBar.tpl', 73, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['gui']->tprojectID): ?>
	<?php if ($this->_tpl_vars['gui']->grants->view_testcase_spec == 'yes'): ?>
		...
		<input style="font-size: 80%; position:relative; top:-1px;" type="text" size="<?php echo $this->_tpl_vars['gui']->searchSize; ?>
"
