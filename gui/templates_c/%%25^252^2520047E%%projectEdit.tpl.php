<?php /* Smarty version 2.6.26, created on 2020-03-27 22:42:55
         compiled from project/projectEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'basename', 'project/projectEdit.tpl', 24, false),array('modifier', 'replace', 'project/projectEdit.tpl', 24, false),array('modifier', 'escape', 'project/projectEdit.tpl', 49, false),array('function', 'config_load', 'project/projectEdit.tpl', 25, false),array('function', 'lang_get', 'project/projectEdit.tpl', 31, false),)), $this); ?>
...
<?php echo lang_get_smarty(array('var' => 'labels','s' => 'show_event_history,th_active,cancel,info_failed_loc_prod,invalid_query,
    ...
    warning_empty_tproject_name'), $this);?>
...
";
	var warning_empty_tcase_prefix = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_tcase_prefix'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
	var warning_empty_tproject_name = "<?php echo ((is_array($_tmp=$this->_tpl_vars['labels']['warning_empty_tproject_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
";
	<?php echo '
